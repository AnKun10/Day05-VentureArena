...
- Bot điều khiển (5 slash commands + rebuild/replication): `codebase/bot/` — xem `codebase/bot/README.md`.
- Backend (ingest bản tin, recsys gợi ý, Q&A `/api/ask`): `codebase/backend/README.md`.
- Kế hoạch tổng: `MASTERPLAN.md`.
